...
public class ListMhsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference =
                FirebaseDatabase.getInstance("https://praktikum-firebase-31f15-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("mhs");
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds: dataSnapshot.getChildren()) {
                    ...
                    String nim =
                            ds.child("nim").getValue().toString();
                    String nama =
        ...
        }); btnBack = findViewById(R.id.btn_back); btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
