...
public class TambahMhsActivity extends AppCompatActivity {
    ...
    private void insertData() {
        ...
        database = FirebaseDatabase.getInstance("https://praktikum-firebase-31f15-default-rtdb.asia-southeast1.firebasedatabase.app/");
        ...
        btnTambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (nim.equals("") || nama.equals("") ||
                        jurusan.equals("") || angkatan.equals("")) {
                    ...
                    myref.child(nim).setValue(mhs).addOnSuccessListener(new OnSuccessListener < Void > () {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Toast.makeText(TambahMhsActivity.this, "Data berhasil ditambahkan ", Toast.LENGTH_SHORT).show();
                                    etNIM.setText(""); etNama.setText(""); etJurusan.setText(""); etAngkatan.setText("");
                        }
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(TambahMhsActivity.this, "Data Gagal ditambahkan",
